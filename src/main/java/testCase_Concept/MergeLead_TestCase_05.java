...
//@Test
//public void MergeLead_TestCase_05() throws InterruptedException {
...
//Click on Icon near From Lead
		...
		System.out.println("***********  Merge Lead HW  *******************");
...
//Enter Lead ID
		driver.findElementByXPath("//input[@type='text']").sendKeys("10538");
...
//Enter Lead ID 10539 to merge
		driver.findElementByXPath("(//input[@type='text'])[1]").sendKeys("10539");
//Click Find Leads button
		driver.findElementByXPath("//button[text()='Find Leads']").click();
//Click First Resulting lead
		Thread.sleep(3000);
...
// But Verify error message  -------
	...
	System.out.println("***********Merge Lead HW Done *******************");
