...
public class CreateLead_TestNg_Priority {
...
public void login() throws InterruptedException {			
	...
	//Launch the Browser
			driver.get("http://leaftaps.com/opentaps");						//Load Leaf taps web page 
...
//Verify the First name	
			Thread.sleep(3000);
			System.out.println("***********Create Lead Test NG HW*************************");
			...
			}System.out.println("***********Create Lead Test NG HW Done********************");
